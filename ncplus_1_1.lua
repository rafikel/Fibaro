...
if (a=="on") then
  ...
  -- connect to server
  fibaro:debug("Connecting to [fibaro.bialykosciol.pl]...");
  local tcpSERVER = Net.FHttp("fibaro.bialykosciol.pl", 80);
...
fibaro:debug("Preparing global variable base on [" .. virtualName .. "]...");
